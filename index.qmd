...
write.table(m_trns, "res/m_com_trns.csv",
            sep = ";", dec = ".", #"\t",
            row.names = TRUE,
            quote = TRUE,
            append = FALSE)
...
m_dist <- vegdist(m_trns, method = "bray",
                   diag = TRUE,
                   upper = FALSE)
save(m_dist, file = "res/m_dist.RData")
load("res/m_dist.RData")

cluster_uas <- hclust(m_dist, method = "average")
png("res/fig-cluster.png", width = 9, height = 7, units = "in", res = 400)
...
png("res/fig-heatmap_uas.png", width = 9, height = 7, units = "in", res = 400)
