...
<!--# This study describes the richness and density of zooplankton, comparatively between two small head water streams: one that originates withing a protected area - Biological Reserve, or REBIO, according to @brasil2000 - and its course extends beyond its administrative boundaries [@mma2003] and a second one that flows entirely outside of the conservation unit. We use hierarchical additive partitioning to evaluate the relative contribution of different spatial scales to the diversity of zooplankton assemblages in these two streams subject to different levels of environmental pressures. Given the importance of the Atlantic Forest to the biodiversity [@pereira2026], we aim with this study, (1) to infer environmental degradation from species turnover [@baselga2010] and (2) to associate beta-diversity to the ecological health of sites inside and surrounding a protected area of Atlantic Forest. This will enable decision makers to take action on the influence of anthropogenic threats and the ecological consequences of the management of the riparian zone. Given the expected different levels of environmental pressures [@gouveia2017], we hypothesize that the diversity is not homogeneously distributed among the different spatial scales but concentrated at the finer levels of pools and river reaches. Some environmental features (reach morphology, habitat structure, and water quality) are also described to explore possible explaining factors for the observed patterns. -->
