...
#| code-fold: true
#| code-overflow: wrap
#| code-summary: "Code: Inserindo Tabela"
...
fauna.zoo_seco <- t(fauna.zoo_seco)
head(fauna.zoo_seco)
ncol(fauna.zoo_seco)
dim(fauna.zoo_seco)
#view(fauna.zoo_seco)
...
#| code-fold: true
#| code-overflow: wrap
#| code-summary: "Code: Aditivo - Seco"
...
##Salvar como .xlsx
library(openxlsx)
write.xlsx(diversity_data_seco, "diversity_data_seco.xlsx", rowNames = TRUE)

##Salvar tabela como gt
tabela_gt <- gt::gt(diversity_data_seco, rownames_to_stub = FALSE)
tabela_gt
gtsave(tabela_gt, "gt-adip-riac_s_gttable.html")
gtsave(tabela_gt, "fig-adip-riac_s_gttable.png")
saveRDS(tabela_gt, "gt-adip-riac_s_gttable.rds")

# Tabela final ajustada no Excel
library(readxl)
adip_riac_s_gttable <- read_excel(
  path  = "diversity_data_seco.xlsx",
  sheet = "Sheet 1",
  range = "A1:J8")
# remover coluna ...1
adip_riac_s_gttable <- adip_riac_s_gttable[, -1]
adip_riac_s_gttable
library(gt)
adip_riac_s_gttable <- gt(adip_riac_s_gttable)
adip_riac_s_gttable <- sub_missing(adip_riac_s_gttable,
                      columns = everything(), missing_text = "")
#adip_riac_s_gttable <- fmt_number(adip_riac_s_gttable, columns = "F.O.(%)", decimals = 1)
adip_riac_s_gttable
gtsave(adip_riac_s_gttable, "gt_adip-riac_s_gttable_xlsx.html")
saveRDS(adip_riac_s_gttable, "gt_adip-riac_s_gttable_xlsx.rds")
...
##Salvar como .xlsx
library(openxlsx)
write.xlsx(diversity_data_seco.bb, "diversity_data_seco.bb.xlsx", rowNames = TRUE)

##Salvar tabela como gt
tabela_gt <- gt::gt(diversity_data_seco.bb, rownames_to_stub = FALSE)
tabela_gt
gtsave(tabela_gt, "gt-adip-bb_s_gttable.html")
gtsave(tabela_gt, "fig-adip-bb_s_gttable.png")
saveRDS(tabela_gt, "gt-adip-bb_s_gttable.rds")

# Tabela final ajustada no Excel
library(readxl)
adip_bb_s_gttable <- read_excel(
  path  = "diversity_data_seco.bb.xlsx",
  sheet = "Sheet 1",
  range = "A1:J6")
# remover coluna ...1
adip_bb_s_gttable <- adip_bb_s_gttable[, -1]
adip_bb_s_gttable
library(gt)
adip_bb_s_gttable <- gt(adip_bb_s_gttable)
adip_bb_s_gttable <- sub_missing(adip_bb_s_gttable,
                      columns = everything(), missing_text = "")
#adip_bb_s_gttable <- fmt_number(adip_bb_s_gttable, columns = "F.O.(%)", decimals = 1)
adip_bb_s_gttable
gtsave(adip_bb_s_gttable, "gt_adip-bb_s_gttable_xlsx.html")
saveRDS(adip_bb_s_gttable, "gt_adip-bb_s_gttable_xlsx.rds")
...
##Salvar como .xlsx
library(openxlsx)
write.xlsx(diversity_data_seco.bb, "diversity_data_seco.ca.xlsx", rowNames = TRUE)

##Salvar tabela como gt
tabela_gt <- gt::gt(diversity_data_seco.ca, rownames_to_stub = FALSE)
tabela_gt
gtsave(tabela_gt, "gt-adip-ca_s_gttable.html")
gtsave(tabela_gt, "fig-adip-ca_s_gttable.png")
saveRDS(tabela_gt, "gt-adip-ca_s_gttable.rds")

# Tabela final ajustada no Excel
library(readxl)
adip_ca_s_gttable <- read_excel(
  path  = "diversity_data_seco.ca.xlsx",
  sheet = "Sheet 1",
  range = "A1:J6")
# remover coluna ...1
adip_ca_s_gttable <- adip_ca_s_gttable[, -1]
adip_ca_s_gttable
library(gt)
adip_ca_s_gttable <- gt(adip_ca_s_gttable)
adip_ca_s_gttable <- sub_missing(adip_ca_s_gttable,
                      columns = everything(), missing_text = "")
#adip_bb_s_gttable <- fmt_number(adip_ca_s_gttable, columns = "F.O.(%)", decimals = 1)
adip_ca_s_gttable
gtsave(adip_ca_s_gttable, "gt_adip-ca_s_gttable_xlsx.html")
saveRDS(adip_ca_s_gttable, "gt_adip-ca_s_gttable_xlsx.rds")
...
#| code-fold: true
#| code-overflow: wrap
#| code-summary: "Code: Aditiva - Chuvoso"
...
#| code-fold: true
#| code-overflow: wrap
#| code-summary: "Code: Multiplicativa - Seco"
...
#| code-fold: true
#| code-overflow: wrap
#| code-summary: "Code: Multiplicativa - Chuvoso"
...
# Declaração sobre o uso de inteligência artificial generativa e tecnologias assistidas por IA no processo de preparação do manuscrito
