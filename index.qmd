...
### FILTRANDO AS VARIÁVEIS### FILTRANDO AS VARIÁVEIS### FILTRANDO AS VARIÁVEIS
...
![Biplot da Análise de Componentes Principais (PCA) das unidades amostrais (UAs) e das variáveis ambientais nos riachos Barro Branco e Caiana durante o período de estudo. Os pontos representam as UAs, enquanto os vetores indicam as variáveis ambientais associadas à estrutura do habitat. As elipses representam regiões de confiança de 95% para a distribuição dos grupos de pontos, calculadas com base na distribuição *t*.](res/fig-hab_PCA_ref-site.png){#fig-hab_PCA_ref-site}

![Biplot da Análise de Componentes Principais (PCA) das unidades amostrais (UAs) e das variáveis ambientais nos riachos Barro Branco e Caiana durante o período chuvoso. Os pontos representam as UAs, enquanto os vetores indicam as variáveis ambientais associadas à estrutura do habitat.](imagens/pesquisa_cientifica.jpg){#fig-pcachuvoso}

![Diagrama de Venn indicando o número de espécies compartilhadas e exclusivas representadas a partir dos componentes de diversidade alfa (α) dos riachos Barro Branco (B) e Caiana (C) da REBIO Guaribas no período seco (S).](imagens/pesquisa_cientifica.jpg){#fig-venn-seco}

![Diagrama de Venn indicando o número de espécies compartilhadas e exclusivas representadas a partir dos componentes de diversidade alfa (α) dos riachos Barro Branco (B) e Caiana (C) da REBIO Guaribas no período chuvoso (C).](imagens/pesquisa_cientifica.jpg){#fig-venn-chuvoso}

![Diversidade observada e esperada do período seco, dividida em componentes alfa e três/dois betas, expressa em porcentagem da riqueza total em (A) ambos os riachos; (B) Barro Branco; e (C) Caiana. Alpha.1 = unidade de amostragem, beta.2 = variação entre habitats; beta.2 = variação entre pontos; beta.3 = variação entre riachos.](imagens/pesquisa_cientifica.jpg){#fig-diversidadeobs-riachos-seco}

![Diversidade observada e esperada do período chuvoso, dividida em componentes alfa e três/dois betas, expressa em porcentagem da riqueza total em (A) ambos os riachos; (B) Barro Branco; e (C) Caiana. Alpha.1 = unidade de amostragem, beta.2 = variação entre habitats; beta.2 = variação entre pontos; beta.3 = variação entre riachos.](imagens/pesquisa_cientifica.jpg){#fig-diversidadeobs-riachos-chuvoso}
...
<summary>Tab.: Tabela de ausência e presença de espécies durante o período seco</summary>

```{r tbl-seco_gttable}
#| eval: false
#| echo: false
#| tbl-cap: "Tabela de ausência e presença de espécies durante o período seco."
readRDS("gt-seco_gttable_xlsx.rds")
```
...
<summary>Tab.: Tabela de ausência e presença de espécies durante o período chuvoso</summary>

```{r tbl-chuvoso_gttable}
#| eval: false
#| echo: false
#| tbl-cap: "Tabela de ausência e presença de espécies durante o período chuvoso."
readRDS("gt-chuvoso_gttable_xlsx.rds")
```
...
<summary>Tab.: Tabela da partição aditiva entre os riachos durante o período seco</summary>

```{r tbl-adip-riac-s_gttable}
#| eval: false
#| echo: false
#| tbl-cap: "Tabela da partição aditiva entre os riachos durante o período seco."
readRDS("gt_adip-riac_s_gttable_xlsx.rds")
```
...
<summary>Tab.: Tabela da partição aditiva do riacho Barro Branco durante o período seco</summary>

```{r tbl-adip-bb-s_gttable}
#| eval: false
#| echo: false
#| tbl-cap: "Tabela da partição aditiva do riacho Barro Branco durante o período seco."
readRDS("gt_adip-bb_s_gttable_xlsx.rds")
```
...
<summary>Tab.: Tabela da partição aditiva do riacho Caiana durante o período seco</summary>

```{r tbl-adip-ca-s_gttable}
#| eval: false
#| echo: false
#| tbl-cap: "Tabela da partição aditiva do riacho Caiana durante o período seco."
readRDS("gt_adip-ca_s_gttable_xlsx.rds")
```
