...
library(readxl)
seco_gttable <- read_excel(
  path  = "venn_seco.xlsx",
  sheet = "Sheet 1",
  range = "A1:C59")
seco_gttable
library(gt)
seco_gttable <- gt(seco_gttable)
seco_gttable <- sub_missing(seco_gttable,
                      columns = everything(), missing_text = "")
#seco_gttable <- fmt_number(seco_gttable, columns = "F.O.(%)", decimals = 1)
seco_gttable
...
##Tabela final ajustada no Excel
library(readxl)
chuvoso_gttable <- read_excel(
  path  = "venn_chuvoso.xlsx",
  sheet = "Sheet 1",
  range = "A1:C59")
chuvoso_gttable
library(gt)
chuvoso_gttable <- gt(chuvoso_gttable)
chuvoso_gttable <- sub_missing(chuvoso_gttable,
                      columns = everything(), missing_text = "")
#chuvoso_gttable <- fmt_number(chuvoso_gttable, columns = "F.O.(%)", decimals = 1)
chuvoso_gttable
...
escalas_seco <- zoo <- read.xlsx("C:/Users/ellen/Dropbox/Universidade/Manuscritos/rebio23-part/dados/rebio23-zoopl.xlsx",
