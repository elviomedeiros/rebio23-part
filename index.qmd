...
spp_gttable <- read_excel(
  ...
  sheet = "tabela_final",
  range = "C1:J48") #ajustar para o tamanho da tabela final
spp_gttable
library(gt)
...
##Salvar como .xlsx
library(openxlsx)
write.xlsx(m_venn, "venn_seco.xlsx", rowNames = TRUE)

##Salvar tabela como gt
tabela_gt <- gt::gt(m_venn, rownames_to_stub = TRUE)
gtsave(tabela_gt, "gt-auspre-s_gttable.html")
gtsave(tabela_gt, "fig-auspre-s_gttable.png")
saveRDS(tabela_gt, "gt-auspre-s_gttable.rds")
...
seco_gttable <- gt(seco_df) |>
  cols_label(`...1` = "Espécies") |>
  sub_missing(columns = everything(), missing_text = "")
seco_gttable
gtsave(seco_gttable, "gt-seco_gttable_xlsx.html")
saveRDS(seco_gttable, "gt-seco_gttable_xlsx.rds")
...
#| code-fold: true
#| code-overflow: wrap
#| code-summary: "Code: Venn - Chuvoso"
...
##Salvar como .xlsx
library(openxlsx)
write.xlsx(m_venn, "venn_chuvoso.xlsx", rowNames = TRUE)

##Salvar tabela como gt
tabela_gt <- gt::gt(m_venn, rownames_to_stub = TRUE)
gtsave(tabela_gt, "gt-auspre-c_gttable.html")
gtsave(tabela_gt, "fig-auspre-c_gttable.png")
saveRDS(tabela_gt, "gt-auspre-c_gttable.rds")

##Tabela final ajustada no Excel
library(readxl)
library(gt)
chuvoso_df <- read_excel(
  path  = "venn_chuvoso.xlsx",
  sheet = "Sheet 1",
  range = "A1:C59"
)
chuvoso_gttable <- gt(chuvoso_df) |>
  cols_label(
    `...1` = "Espécies"
  )
chuvoso_gttable
gtsave(chuvoso_gttable, "gt-chuvoso_gttable_xlsx.html")
saveRDS(chuvoso_gttable, "gt-chuvoso_gttable_xlsx.rds")
...
![Mapa da área de influência da REBIO Guaribas.](imagens/Mapa (pt-br).png){#fig-mapa}
...
<summary>Fig.: Análise de Componentes Principais das variáveis ambientais por riacho</summary>

![Análise de Componentes Principais (PCA) das variáveis ambientais, categorizados por riacho.](res/fig-hab_PCA_rio.png){#fig-hab_PCA_rio}

</details>

<details>

<summary>Fig.: Etapas do desenvolvimento da pesquisa científica</summary>
