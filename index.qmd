...
write.table(m_part_cols, "results/m_hab_part.csv",
            sep = ";", dec = ".", #"\t",
            row.names = TRUE,
            quote = TRUE,
            append = FALSE)
write.table(nutrientes, "results/t_nutri.csv",
            sep = ";", dec = ".", #"\t",
            row.names = TRUE,
            quote = TRUE,
            append = FALSE)
write.table(t_grps, "results/t_grps.csv",
            sep = ";", dec = ".", #"\t",
            row.names = TRUE,
            quote = TRUE,
            append = FALSE)
t_grps <- read.csv("results/t_grps.csv",
                   sep = ";", dec = ".",
                   row.names = 1,
                   header = TRUE,
                   na.strings = NA)
t_nutri <- read.csv("results/t_nutri.csv",
                  sep = ";", dec = ".",
                  row.names = 1,
                  header = TRUE,
                  na.strings = NA)
m_hab <- read.csv("results/m_hab_part.csv",
                  sep = ";", dec = ".",
                  row.names = 1,
                  header = TRUE,
                  na.strings = NA)
...
library(psych)
colnames(m_hab)
png("results/fig-h.hab_pairs.png")
...
library(corrplot)
png("results/fig-hab_corrplot.png")
corrplot(cor, method = "circle")
dev.off()

##DELETANDO COLINEARES OU INDESEJADAS----

sink(file = "results/colineares.txt", append = F, split = T)
colnames(m_hab)
del_cols <- c("", "")
...
write.table(m_hab_part, "results/m_hab_part.csv",
            sep = ";", dec = ".", #"\t",
            row.names = TRUE,
            quote = TRUE,
            append = FALSE)
m_hab_part <- read.csv("results/m_hab_part.csv",
                       sep = ";", dec = ".",
                       row.names = 1,
                       header = TRUE,
                       na.strings = NA)
...
# Salvado m_hab_trns
write.table(hab_trns, "results/m_hab_trns.csv",
            sep = ";", dec = ".", #"\t",
            row.names = TRUE,
            quote = TRUE,
            append = FALSE)
m_hab_trns <- read.table("results/m_hab_trns.csv",
                         sep = ";", dec = ".",
                         row.names = 1,
                         header = TRUE,
                         na.strings = NA)
...
#cat("\014")
library(openxlsx)
dados_bruto <- read.xlsx("C:/Users/ellen/Downloads/Manuscritos/rebio23-part/dados/rebio23-habitat.xlsx",
                         rowNames = T,
                         colNames = T,
                         sheet = "ambiente",
                         na.strings = "n/a",
